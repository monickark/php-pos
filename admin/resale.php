...
//test
 ...
 $signimgname = 'sign_'.time().'.png';
$t='signs/sign_'.time().'.png';
 
$qry_con_u = mysqli_query($conn,"UPDATE `resale_details` SET `sign` = '$signimgname' WHERE `resale_details`.`id` = ".$ordid." ");
 
   $select_sign = "SELECT * FROM resale_details WHERE id = '$ordid'";
                   $qry_sign = mysqli_query($conn,$select_sign);
               $res_sign = mysqli_fetch_array($qry_sign);
  $cussign = $res_sign['sign'];


$sogan=base30_to_jpeg($imgStr,$t);
 ...
 Signature:
  ...
  <img src="http://www.infogenx.com/retailpos/admin/signs/'.$cussign.'" height="75" width="250"></div>
                        ...
                        <td colspan="2" class="text-right" style="text-align:right"><span class="h4"><b>TOTAL</b>  :</span></td>
...
<div id="thanks" style="width:70%;margin:0 auto;margin-top:30px">
<div>
<h2 style="color:#444"><u>Terms And Conditions</u></h2>
<p style="color:#494f52">Terms and Conditions are a set of rules and guidelines that a user must agree to in order to use your website or mobile app. </p>
        <p style="color:#494f52">It acts as a legal contract between you (the company) who has the website or mobile app and the user who access your website and mobile app.</p>
        <p style="color:#494f52">It’s up to you to set the rules and guidelines that the user must agree to. You can think of your Terms and Conditions agreement as the legal agreement where you maintain your rights to exclude users from your app in the event that they abuse your app, and where you maintain your legal rights against potential app abusers, and so on.</p>
        <p style="color:#494f52">Terms and Conditions are also known as Terms of Service or Terms of Use.</p>
        <p style="color:#494f52">This type of legal agreement can be used for both your website and your mobile app. It’s not required (it’s not recommended actually) to have separate Terms and Conditions agreements: one for your website and one for your mobile app.</p>
</div>
...
<input type="checkbox" name="check" id="check"> I Agree the Terms And Conditons
