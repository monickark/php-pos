  ...
  <div class="panel">
     <div class="panel-body">
            ...
            <header class="panel-heading">
              <h3 class="panel-title">Add Taxes
                ...
                <!-- Basic Form Elements Content -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="taxName" name="taxName" class="form-control" placeholder="Enter tax Name" value="" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="taxpercentage" name="taxpercentage" class="form-control" placeholder="Enter tax Presentage" value="" required="">
