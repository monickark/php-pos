...
*/
  ...
  /*  alert(quantity);*/
            ...
            <button type="submit" value="submit" name="submit" class="btn btn-primary  btn-round" style="float: right">Submit order
            </button>       
                    </div>
...
sno++;
        ...
        var updrow ='<tr class="even pointer" id="final"><td><input type="hidden" id="ident'+sno+'" name="sid[]" value="'+proid+'">&nbsp;'+pname+' &nbsp;'+pcolor+' &nbsp; '+pcapcty+'<input type="hidden" name="pname[]" value="'+pname+'"><input type="hidden" name="proid[]" value="'+proid+'"></td><td>&nbsp;<div style="float: left;margin-top: 5px;" id="price'+proid+'" value="'+price+'">'+price+'</div>&nbsp; </td><td>     <input type="hidden" id="imei'+proid+'" name="imei[]" value="'+imeino+'">'+imeino+'</td><td> <input type="text" id="disc'+proid+'" name="pqty[]" class="form-control" onkeyup="findtot('+proid+');" size="30" value="'+discount+'" " class="form-control col-md-2"></td><td>&nbsp;<div style="float: left; " id="tot'+proid+'">$. '+price+'</div><input type="hidden" name="itemtot[]" id="itemtot'+proid+'" value="" class="itemtotal">&nbsp; </td><td>&nbsp; <a href="javascript:void(0);" class="remCF btn btn-round btn-outline btn-danger btn-sm">Remove</a></td></tr>'; 
