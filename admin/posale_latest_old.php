...
$brands=mysqli_query($conn,'SELECT * FROM brand WHERE varBrandName NOT LIKE "%Accessories%"');
            ...
            <li>
              <div class="panel">
                <figure class="overlay overlay-hover animation-hover">
                  <img class="caption-figure overlay-figure" src="../global/images/<?php echo $brd['bimg'];  ?>" height="50" width="42">
...
$categor=mysqli_query($conn,'SELECT * FROM brandmodel');
while($cat=mysqli_fetch_array($categor))
{

$bnrand=mysqli_query($conn,'SELECT * FROM brand WHERE intId = "'.$cat['bmodel_brandid'].'" AND varBrandName LIKE "%Accessories%"');
...
/*alert("Maan");*/
var id=$(".idcls").val();
var discount=$(".discls").val();
var amt=$(".pricls").val();
var aftdisc=$(".aftdiscls").val();
