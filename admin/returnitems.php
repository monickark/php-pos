...
$item_det=mysqli_query($conn,'SELECT * FROM purchase  WHERE status="5" OR status="6" ;');

$sno=1;
while($items=mysqli_fetch_array($item_det))
{

$item_fet=mysqli_query($con,'SELECT * FROM items WHERE intId="'.$items['intItemId'].'";');
$ite=mysqli_fetch_array($item_fet);

$colour=mysqli_query($con,'SELECT * FROM colour WHERE colour_id="'.$ite['color'].'";');
...
/*
$brand_det=mysqli_query($con,'SELECT * FROM brand WHERE intId="'.$ite['brand'].'";');
...
?>
                ...
                <tr>
                  <td><?php echo $sno; ?></td>
                   <td><?php echo $ite['itemname']."-".$col['colour_name']."-".$cap['capacity_name']; ?></td>
                  <td><?php echo $items['intOrderId']; ?></td>
                  <td><?php echo $items['itemqty']; ?></td>
                  <td><?php echo $items['approve_qty']; ?></td>
