  ...
  <div class="panel">
     <div class="panel-body">
               ...
               <form id="brandForm" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 txtOnly">
                            <input type="text" id="cashName" name="cashName" class="form-control" placeholder="Enter Cash Name" value="" required="">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea id="cashDescription" name="cashDescription" rows="9" class="form-control" placeholder="Cash Description.."></textarea>
                        </div>
                    </div>
         ...
         <div class="col-lg-6">
             <div class="panel">
          <header class="panel-heading">
            <h3 class="panel-title">View Cash Typs</h3>
          </header>
          <div class="panel-body">
            <div class="row">
              <div class="col-md-6">
