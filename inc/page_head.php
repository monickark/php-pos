...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Retail Pos | Retail Admin  </title>
  ...
  <link rel="stylesheet" href="../global/vendor/asrange/asRange.min.css?v4.0.2">

  <!-- Page -->
  <link rel="stylesheet" href="../assets/examples/css/uikit/icon.min.css?v4.0.2">
    <!-- datatable style -->
