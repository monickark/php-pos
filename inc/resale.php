                     ...
                     $message .=' <tr style="background-color:#f9f9f9">
                        ...
                        <td style="padding:4px">
                          ...
                          <td class="text-center" style="padding:4px"><strong>'.$res_pur['imei'].'</strong></td> 
                           <td class="text-center" style="padding:4px"><strong>'.$res_pur['purchase_cost'].'</strong></td>                        
                    </tr>';  

                                   $message .='</tbody> 
  <tfoot>
    <tr class="active">
      <td> <div id="signma" >Signature';
      $sogan=base30_to_jpeg($imgStr, 'test.png');
  
    $message .='<img src="'.$sogan.'" height="62" width="150">
...
</td>   <td colspan="2" class="text-right" style="text-align:right"><span class="h4"><b>TOTAL</b>  :</span></td>
                        <td class="text-left" style="text-align:left"><span class="h4">'. $res_pur['purchase_cost'].'</span></td>
