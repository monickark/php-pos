<style type="text/css">
  .navbar-brand.navbar-brand-center{padding: 10px 10px !important;}
  .navbar-brand.navbar-brand-center img{width: 148px !important;}
  .navbar-toolbar .nav-item.hidden-float .nav-link{margin-left:100px !important;}
</style>
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse bg-indigo-600"
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center">
          <img class="" src="../assets/images/logo.png" title="Remark">
          <span class="navbar-brand-text hidden-xs-down"> Retail POS</span>
        </div>
          ...
          <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" role="menu">
                ...
                <!--<a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon wb-payment" aria-hidden="true"></i> Billing</a>s
