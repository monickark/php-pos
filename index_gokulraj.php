...
<html class="no-js css-menubar" lang="en">
  ...
  .page-login-v2 .page-brand-info {margin: 220px 87px 0 0px; padding: 25px;text-align: center;}
...
*/  $_SESSION['sessionid'] = session_id();
          ...
          echo '<script> window.location.assign("admin/index.php?type=login&flag=success");</script>';
}
else{
...
*/  $_SESSION['sessionid'] = session_id();
   ...
   echo '<script> window.location.assign("user/index.php?type=login&flag=success");</script>';
}
else{
//  echo '<script>alert("Email id or password is worng.");window.location.assign("index.php");</script>';
    header("location:index.php?type=login&flag=error#loginerror");
        ...
        <div class="page-login-main animation-slide-right animation-duration-1">
          ...
          <form method="post" action="">
            ...
            <div class="form-group clearfix">
              ...
              <a class="float-right"  <a href="javascript:void(0)" id="link-reminder-login">Forgot password?</a>
            </div>
            <button type="submit" class="btn btn-primary btn-block"onclick="setText()">Sign in</button>
          </form>
